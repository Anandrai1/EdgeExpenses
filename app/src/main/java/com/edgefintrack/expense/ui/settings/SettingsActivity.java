package com.edgefintrack.expense.ui.settings;
...
public class SettingsActivity extends PreferenceActivity
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.tv_income_categories:
                CategoriesIntent.putExtra("mCurrentMode", IExpensesType.MODE_INCOME);
                startActivity(CategoriesIntent);
                overridePendingTransition(R.anim.anim_slide_in_left, R.anim.anim_slide_out_left);
                break;
            case R.id.tv_expense_categories:
                CategoriesIntent.putExtra("mCurrentMode", IExpensesType.MODE_EXPENSES);
                startActivity(CategoriesIntent);
                overridePendingTransition(R.anim.anim_slide_in_left, R.anim.anim_slide_out_left);
                break;
