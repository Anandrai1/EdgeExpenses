package com.edgefintrack.expense.ui.history;
...
import com.edgefintrack.expense.adapters.BaseExpenseAdapter;
...
import com.edgefintrack.expense.custom.SelectDateFragment;
import com.edgefintrack.expense.custom.SparseBooleanArrayParcelable;
import com.edgefintrack.expense.custom.WrapContentManagerRecyclerView;
...
import com.edgefintrack.expense.interfaces.ISelectDateFragment;
import com.edgefintrack.expense.ui.MainActivity;
import com.edgefintrack.expense.ui.MainFragment;
import com.edgefintrack.expense.ui.expenses.ExpenseDetailActivity;
import com.edgefintrack.expense.ui.expenses.ExpenseDetailFragment;
import com.edgefintrack.expense.utils.DateManager;
import com.edgefintrack.expense.utils.DialogManager;
import com.edgefintrack.expense.utils.ExpensesManager;
import com.edgefintrack.expense.utils.FileManager;
import com.edgefintrack.expense.utils.HistoryFileParser;
...
public class HistoryFragment extends MainFragment implements BaseViewHolder.RecyclerClickListener, ISelectDateFragment {
    ...
    private void writeFile() {
        ...
        } catch (@SuppressLint("NewApi") FileUriExposedException e) {
            e.printStackTrace();
        }
